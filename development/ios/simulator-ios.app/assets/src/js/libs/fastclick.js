...
/* This came from https://github.com/ftlabs/fastclick */
...
FastClick.prototype.onTouchEnd = function(event) {
	'use strict';
	var forElement, trackingClickStart, targetTagName, targetElement = this.targetElement, touch = event.changedTouches[0];
